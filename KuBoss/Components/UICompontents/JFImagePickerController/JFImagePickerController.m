...
- (void)viewDidLoad
{
	...
	selectNum = [[UIBarButtonItem alloc] initWithTitle:[NSString stringWithFormat:@"0/%d", ASSET_PHOTO_MAX_COUNT] style:UIBarButtonItemStylePlain target:nil action:nil];
	...
	selectNum.title = [NSString stringWithFormat:@"%ld/%d", (unsigned long)ASSETHELPER.selectdPhotos.count, ASSET_PHOTO_MAX_COUNT];
}
