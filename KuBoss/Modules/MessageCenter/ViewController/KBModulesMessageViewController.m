//
//  KBMoulesMessageViewController.m
//  KuBoss
//
...
#import "KBModulesMessageViewController.h"
#import "KBCommonMessageCell.h"
#import "MJRefresh.h"

@interface KBModulesMessageViewController ()
...
@implementation KBModulesMessageViewController

- (void)viewDidLoad {
    [super viewDidLoad];
      self.view.backgroundColor = [UIColor whiteColor];
    self.list = [[NSMutableArray alloc]init];
    [self setCustomTitle:@"业务通知"];
    self.view.backgroundColor = [UIColor whiteColor];
...
- (void)api
{
    ...
    [[KBApiLayer sharedInstance] messageMoudulespageIndex:self.indexPage pageSize:kPageSize success:^(KBMessageMoudulesModel *model) {
        if (self.isClear) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setModulesItem:[self.list objectAtIndex:indexPath.row]];
